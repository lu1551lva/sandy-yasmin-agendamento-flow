  ...
  (
    ...
    const button = (
      <Comp
        ...
        className={cn(
          "flex w-full items-center gap-2 overflow-hidden rounded-md p-2 text-sm outline-none ring-sidebar-ring transition-[width,height,padding] hover:bg-sidebar-accent focus-visible:ring-2 [&>svg]:size-4 [&>svg]:shrink-0",
          className
        )}
        {...props}
      />
